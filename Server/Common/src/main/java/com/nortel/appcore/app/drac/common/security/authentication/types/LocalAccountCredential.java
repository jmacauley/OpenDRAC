...
public final class LocalAccountCredential extends AbstractCredential {
	private static final long serialVersionUID = 1L;

	public LocalAccountCredential(String userID, String password,
	    IPAddress ipAddress) {
		super(userID, password, ipAddress,
