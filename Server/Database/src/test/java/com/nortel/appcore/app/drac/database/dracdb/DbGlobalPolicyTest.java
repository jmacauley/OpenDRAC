...
public final class DbGlobalPolicyTest {
	...
	public void testGetGlobalPolicy() throws Exception {
		DbGlobalPolicy.INSTANCE.getGlobalPolicy();
	}

	@Test
	public void testGetInstance() {
		assertNotNull(DbGlobalPolicy.INSTANCE);
	}

	@Test
	public void testSetDefaultGlobalPolicy() throws Exception {
		DbGlobalPolicy.INSTANCE.setDefaultGlobalPolicy(
		    DbGlobalPolicy.INSTANCE.getGlobalPolicy());
	}
