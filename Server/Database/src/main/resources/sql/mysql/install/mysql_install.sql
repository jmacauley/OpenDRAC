...
CREATE TABLE IF NOT EXISTS `drac`.`GlobalPolicy` (
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS  `drac`.`LightPathAlarmDetails`(
...
--
CREATE TABLE  IF NOT EXISTS  `drac`.`LightPathEdge` (
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`LightPath` (
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`NetworkElementAdjacency`(
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS  `drac`.`NetworkElementConnection` (
  `pk` varchar(255) COLLATE utf8_bin NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`NetworkElementFacility`(
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`NetworkElement` (
  `pk` varchar(255) COLLATE utf8_bin NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`ResourceGroups` (
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`Schedule` (
  `id` varchar(255) COLLATE utf8_bin NOT NULL,
  `activationType` varchar(255) COLLATE utf8_bin NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`UserGroups` (
  `groupId` varchar(255) COLLATE utf8_bin NOT NULL,
  `xml` mediumtext COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`groupId`)
);
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`Users` (
  `userId` varchar(255) COLLATE utf8_bin NOT NULL,
  `xml` mediumtext COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`userId`)
);
...
--
CREATE TABLE IF NOT EXISTS `drac`.`UserPreferences` (
...
--
CREATE TABLE IF NOT EXISTS `drac`.`inbox` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `fk_inbox_users_userid` FOREIGN KEY `fk_inbox_users_userid` (`userId`) REFERENCES `Users` (`userId`)
);
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `drac`.`logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `time` bigint(20) NOT NULL,
...
--
CREATE TABLE  IF NOT EXISTS `drac`.`outbox` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` varchar(255) NOT NULL,
  `date` bigint(20) NOT NULL,
  `receipient` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `fk_outbox_users_userid` FOREIGN KEY `fk_outbox_users_userid` (`userId`) REFERENCES `Users` (`userId`)
);
...
--
CREATE TABLE  IF NOT EXISTS `drac`.`LightPathAlarmSummaries` (
  `pk` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
CREATE TABLE IF NOT EXISTS `drac`.`Sites` (
  `id` varchar(255) NOT NULL,
