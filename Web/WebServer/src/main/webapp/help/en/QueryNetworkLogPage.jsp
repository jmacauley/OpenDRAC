 ...
 *
 * File: /help/en/listNetworkAuditLogs.jsp
 *
 * Description:
...
<span class="gen">
	<p>
		<i><b>"<c:out value='${sessionScope["drac.network.auditlogs"]}'/>"</b></i> lists the logs generated during NE management. The <i>"Network Filter</i>" functionality provides a mechanism to view all the audit logs generated within your user profile matching the supplied criteria.
	</p>
	<ul>
		<li>
