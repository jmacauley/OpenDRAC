 ...
 *
 * File: /help/en/createResourceGroup.jsp
 *
 * Description:
 *   This page displays US English help data for the create resource group
 *   functionality.
 *
 ****************************************************************************/
%>
...
<span class="gen">
    <p>
        <b><c:out value='${sessionScope["drac.security.resourceGroupManagement.create"]}'/></b>
        allows the user to create a resource group.
        <ul>
            <li>
            ...
            <ul>
                ...
                <li>
                    ...
                    - The parent of the currently being defined Resource Group. This list is dynamic and is restricted to those resource groups that are permitted as parents for the currently logged in user. 
                </li>
                <br />
            </ul>
