 ...
 *
 * File: /help/en/listSecurityAuditLogs.jsp
 *
 * Description:
...
<span class="gen">
	<p>
		<i><b>"<c:out value='${sessionScope["drac.security.auditlogs"]}'/>"</b></i> lists the logs generated during Login, Logout and User management. The <i>"Security Filter</i>" functionality provides a mechanism to view all the audit logs generated within your
