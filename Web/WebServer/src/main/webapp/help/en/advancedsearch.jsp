...
<span class="gen">
	<p>
		<i><b>"<c:out value='${sessionScope["drac.menu.service.advanced"]}'/>"</b></i> Search for available time slots to create a schedule.<br/>
		To do the search the following criteria must be entered:
		<ol>
