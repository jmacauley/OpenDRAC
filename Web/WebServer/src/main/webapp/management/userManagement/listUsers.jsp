 ...
 * OpenDRAC Web GUI
 *
 * File: /management/userManagement/listUsers.jsp
 *
 * Description:
 *  This page provides the user with a list users filter for generating
 *  a user query.
 *
 ****************************************************************************/

String pageRef = "drac.security.userManagement.list";
%>

<%@ include file="/common/header_struts.jsp"%>

<!-- Start of listUsers.jsp -->
...
function doChangeSearchFor()
{
    ...
    if (document.getElementById("searchBy").value == "allUsers"||
        document.getElementById("searchBy").value == "unassignedUsers") 
    {
...
function checkForData()
{
    ...
    if (obj.value == "allUsers" || obj.value == "unassignedUsers") 
    {
    } 
    else 
    {
...
<html:form method="POST" action="/management/userManagement/listUsersResult.do">
    <table width="350" cellspacing="0" cellpadding="0" border="0" align="center">
        <tbody>
          ...
          <tr>
            <td align="center"><bean:message key="drac.security.userManagement.list.text"/></td>
          </tr>
            ...
            <table cellspacing="0" cellpadding="5" border="0" align="center" class="tbForm">
                ...
                <tr>
                  ...
                  <td class="tbForm1">
                    ...
                    <option value="allUsers" selected><bean:message key="drac.security.userManagement.list.option.allUsers" /></option>
                    <option value="commonName"><bean:message key="drac.security.userManagement.list.option.commonName" /></option>
                    <option value="description"><bean:message key="drac.security.userManagement.list.option.description" /></option>
                    <option value="eMail"><bean:message key="drac.security.userManagement.list.option.email" /></option>
                    <option value="givenName"><bean:message key="drac.security.userManagement.list.option.givenName" /></option>
                    <option value="phone"><bean:message key="drac.security.userManagement.list.option.phone" /></option>                    
                    <option value="postalAddress"><bean:message key="drac.security.userManagement.list.option.postalAddress" /></option>
                    <option value="surname"><bean:message key="drac.security.userManagement.list.option.surname" /></option>
                    <option value="unassignedUsers"><bean:message key="drac.security.userManagement.list.option.unassignedUsers" /></option>
                    <option value="userID"><bean:message key="drac.security.userManagement.list.option.userID" /></option>
                    </select>
                  </td>
