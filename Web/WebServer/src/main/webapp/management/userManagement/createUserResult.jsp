 ...
 * OpenDRAC Web GUI
 *
 * File: /management/userManagement/createUserResult.jsp
 * Author: Colin Hart
 *
 * Description:
 *  This page returns result of creating a user.
 *
 * Note:
 *  This page has basically the same contents as /management/userManagement/userDetails.jsp
 *
 ****************************************************************************/

String pageRef = "drac.security.userManagement.create.success.header";
...
<html:form action="/management/userManagement/createUserResult.do" >
    ...
    <tbody>
        ...
        <tr>
            <td align="center"><font color="green"><b><bean:message key="drac.security.userManagement.create.success"/>&nbsp;
                <bean:write name="UserForm" property="userID" /></font></b></td>
        </tr>
            ...
            <td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tbtbot">
                            <center><b><bean:message key="drac.security.userManagement.detail" /></b></center>
                        </td>
                            ...
                            <div class="tab-pane" id="userPane" align="center">
                                    ...
                                    <table width="95%" cellspacing="1" cellpadding="5" border="0" id="preferencesTable">
                                        <tr>
                                            ...
                                            <td class="tbForm1" align="left">
                                                <logic:empty name="UserForm" property="timeZone">
                                                    &nbsp;
                                                </logic:empty>
                                                <logic:notEmpty name="UserForm" property="timeZone">
                                ...
                                <div class="tab-page" id="userGroupMembershipTab">
                                    ...
                                    <table width="95%" cellspacing="1" cellpadding="5" border="0" id="userGroupMembershipTable">
                                            ...
                                            <td class="tbForm1" nowrap>
                                                ...
                                                <logic:iterate id="memberUserGroupName" name="UserForm" property="memberUserGroupName">
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise><b>${fn:escapeXml(memberUserGroupName)}</b></c:otherwise>
                                                    </c:choose>
                                                </logic:iterate>
                                                </logic:notEmpty>
                                            </td>
                                        ...
                                        <c:if test="${UserForm.authenticationType eq 'A-Select'}">
                                        <tr>
                                            <td class="tbForm1" colspan="2">
                                ...
                                <div class="tab-page" id="policyDetailsTab" align="center">
                                    ...
                                    <table width="95%" cellspacing="1" cellpadding="5" border="0" id="policyDetailsTable">
                                        <tr>
                                            ...
                                            <td class="tbForm1" nowrap align="right" id="dormantPeriodTD">
                                        ...
                                        <tr id="internalAccountRow2">
                                            ...
                                            <td class="tbForm1" nowrap align="right" colspan="2" id="inactivityPeriodTD">
                                        ...
                                        <tr id="internalAccountRow3">
                                            ...
                                            <td class="tbForm1" nowrap align="right" colspan="2" id="lockoutPeriodTD">    
                                        ...
                                        <tr id="internalAccountRow4">
                                            ...
                                            <td class="tbForm1" nowrap align="right" colspan="2" id="passwordAgingTD">
