...
<%
     ...
     *
     * File: /management/userGroupManagement/listUserGroupsResult.jsp
     *
     * Description:
     *   This page displays the results of a list user groups query.
     *
     ****************************************************************************/

    String pageRef = "drac.security.userGroupManagement.list.results";
%>
				...
				<tbody>
					...
					<tr>
						...
						<center><b><bean:message
							key="drac.security.userGroupManagement.list.results.title" /></b></center>
						</td>
		...
		<tr>
			...
			<table cellspacing="0" cellpadding="5" border="0" align="center"
				...
				<tbody>
					...
					<logic:empty name="indexedTreeNodesOfGroupsAndUsers"
						scope="request">
						<tr>
							<td colspan="9" align="center" class="gen"><bean:message
								key="drac.security.userGroupManagement.list.results.notavailable" />
							</td>
						</tr>
					</logic:empty>


					<logic:notEmpty name="indexedTreeNodesOfGroupsAndUsers"
						scope="request">
						...
						<tr>
							...
							<td align="left" valign="top" class="tbForm1">
							<p><a href="javascript: d2.openAll();"><i>open all</a> |
							<a href="javascript: d2.closeAll();">close all</i></a></p>
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" valign="top" class="tbForm1">
							<table class="tbForm" align="left" border="5" cellpadding="5"
								cellspacing="0">
								<tbody>
									<tr>
										<td class="tbForm1" nowrap="nowrap">Find:</td>
										<td class="tbForm1" nowrap="nowrap"><input
											name="searchForD2" value="" id="searchForD2" type="text"
											onkeypress="checkKey(d2, 'searchForD2', event);"> <a
											href="JavaScript:void(0);" tabindex="-1"
											onclick="JavaScript:d2.find('decr', document.getElementById('searchForD2').value);">
										<img src="/images/arrow_beak_up.gif" style="height: 13px"
											border="0" align="top" vspace="0" hspace="0"></a> <a
											href="JavaScript:void(0);" tabindex="-1"
											onclick="JavaScript:d2.find('incr', document.getElementById('searchForD2').value);">
										<img src="/images/arrow_beak_down.gif" style="height: 13px"
											border="0" align="top" vspace="0" hspace="0"></a></td>
									</tr>
								</tbody>
						...
						<tr>
							<td align="left" valign="top" class="tbForm1"><script
								type="text/javascript">
                                    ...
                                    <logic:iterate name="indexedTreeNodesOfGroupsAndUsers" id="treeNode" scope="request">
					...
					<c:otherwise>
                                            d1.add ( '${treeNode.idx}',
                                                      ...
                                                      '<b>User id: </b>' + '${treeNode.clientSafeName}',
                                                      '',
                                                      '/images/User.gif',
                                                      '/images/User.gif'
                                             );
							...
							<td align="left" valign="top" class="tbForm1"><script
								type="text/javascript">
                                    ...
                                    d2.add(0,-1,'Resource Group Membership');
                            
                                    <logic:iterate name="indexedTreeNodesOfGroupsAndResourceGroups" id="treeNode" scope="request">
                                    <logic:present name="treeNode">
