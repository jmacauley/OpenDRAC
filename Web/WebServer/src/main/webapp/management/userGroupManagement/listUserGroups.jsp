 ...
 * OpenDRAC Web GUI
 *
 * File: /management/userGroupManagement/listUserGroups.jsp
 *
 * Description:
 *
 ****************************************************************************/

String pageRef = "drac.security.userGroupManagement.list";
%>

<%@ include file="/common/header_struts.jsp"%>

<!-- Start of listUserGroups.jsp -->
...
function doChangeSearchFor()
{
    ...
    if (document.getElementById("searchBy").value == "allUserGroups")
    {
...
function checkForData()
{
    ...
    ListUserGroupsForm.submit();
}

</script>

<html:form method="POST" action="/management/userGroupManagement/listUserGroupsResult.do">
    ...
    <tbody>
        ...
        <tr>
            <td align="center"><bean:message key="drac.security.userGroupManagement.list.text"/></td>
        </tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="tbForm1">
                        ...
                        <option value="allUserGroups" selected><bean:message key="drac.security.userGroupManagement.option.all" /></option>
                        <option value="name"><bean:message key="drac.security.userGroupManagement.option.name" /></option>
                        </select>
                    </td>
