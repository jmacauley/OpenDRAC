...
<%String pageRef = "drac.schedule.delete";%>
...
<table width="90%" cellspacing="5" cellpadding="0" border="0" align="center">
	...
	<logic:present name="deletedID" scope="request">
		<tr>
			<td align="center" class="gen">
                <B><font color="green"><bean:message key="drac.text.schedule"/> <c:out value="${deletedID}"/> <bean:message key="drac.verbs.canceled"/></B>
			</td>
		</tr>
	</logic:present>
	...
	<logic:messagesPresent message="true">
		<tr>
		<td align="center" class="gen">
			<b><bean:message key="drac.schedule.detail.deleteStatus" /></b>
		</td>
		</tr>
