...
<%String pageRef = "drac.schedule.confirm";%>
...
<table width="90%" cellspacing="5" cellpadding="0" border="0" align="center">
	...
	<logic:present name="confirmID" scope="request">
		<tr>
			<td align="center" class="gen">
                <B><font color="green"><bean:message key="drac.schedule.confirm.success" arg0="${confirmID}"/></font></B>
			</td>
		</tr>
	</logic:present>
	...
	<logic:messagesPresent message="true">
		<tr>
		<td align="center" class="gen">
            <b><bean:message key="drac.schedule.detail.confirmStatus" /></b>
		</td>
		</tr>
