...
<%String pageRef = "drac.service.delete";%>
...
<table width="90%" cellspacing="5" cellpadding="0" border="0" align="center">
	...
	<logic:messagesPresent message="true">
		...
		<td align="center" class="gen">
			<b><bean:message key="drac.service.detail.deleteStatus" /></b>
		</td>
		</tr>
	...
	<tr>
		<td align="center" class="gen">
            <B><font color="green"><c:out value="${deletedID}"/> <bean:message key="drac.verbs.canceled"/></B>
		</td>
	</tr>
	</logic:present>
	<tr>
