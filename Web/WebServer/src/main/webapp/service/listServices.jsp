...
<%String pageRef = "drac.service.query";%>
<%@ include file="/common/header_struts.jsp"%>

<SCRIPT LANGUAGE="JavaScript" SRC="/scripts/Service.js"></SCRIPT>
...
<table cellspacing="0" cellpadding="0" border="0" align="center">
    ...
    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tbt">
            ...
            <tr>
                <td class="tbtl"><img src="/images/spacer.gif" alt="" width="22" height="22" /></td>
                <td class="tbtbot"><center><b><bean:message key="drac.service.query.filter"/></b></center></td>
                <td class="tbtrr"><img src="/images/spacer.gif" alt="" width="22" height="22" alt="" /></td>
            </tr>
            </tbody>
        </table>
        ...
        <td>
            ...
            <tbody>
                <tr align='left'>
                    ...
                    <td class="row1">
                        <html:select tabindex="1" styleClass="gen" size="1" property="memberGroup" style="width: 180px">
                ...
                <tr align='left'>
                    <td class="row2">
                        <b><bean:message key="drac.service.query.startdate" />
                        </b>
                    </td>
                    <td class="row2">
                ...
                <tr align='left'>
                    <td class="row1">
                        <b><bean:message key="drac.service.query.enddate" />
                        </b>
                    </td>
                    <td class="row1">
