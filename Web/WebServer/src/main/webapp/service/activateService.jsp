...
<%String pageRef = "drac.service.activate";%>
...
<table width="90%" cellspacing="5" cellpadding="0" border="0" align="center">
    ...
    <logic:messagesPresent message="true">
        ...
        <td align="center" class="gen">
            <b><bean:message key="drac.service.detail.activateStatus" /></b>
        </td>
        </tr>
    ...
    <logic:present name="activateID" scope="request">
    <tr>
        <td align="center" class="gen">
            <B><font color="green"><bean:message key="drac.service.activate.success" arg0="${activateID}"/></B>
        </td>
    </tr>
    </logic:present>
    <tr>
