...
<%String pageRef = "drac.schedule.auditlogs";%>
...
<html:form action="/logs/queryScheduleLogs" method="POST">
    <html:hidden property="auditType" value="RESERVATIONGROUP"/>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="tbt">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tbtbot"><center><b><bean:message key="drac.schedule.log.list.title"/></b></center></td>
