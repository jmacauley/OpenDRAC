...
<%String pageRef = "drac.service.auditlogs";%>
...
<html:form action="/logs/queryServiceLogs" method="POST">
    <html:hidden property="auditType" value="RESERVATION"/>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="tbt">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tbtbot"><center><b><bean:message key="drac.service.log.list.title"/></b></center></td>
