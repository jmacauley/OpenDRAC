...
<%String pageRef = "drac.network.auditlogs";%>
...
<html:form action="/logs/queryNetworkLogs" method="POST">
    <html:hidden property="auditType" value="network"/>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="tbt">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tbtbot"><center><b><bean:message key="drac.network.log.list.title"/></b></center></td>
