...
<%String pageRef = "drac.security.auditlogs.results";%>
...
<table width="98%" cellspacing="5" cellpadding="0" border="0" align="center">
        ...
        <tr>
            <td align="center">
            <logic:empty name="secLogList" scope="request">
                <bean:message key="drac.auditlogs.empty"/>
            </logic:empty>
            <logic:notEmpty name="secLogList" scope="request">
            <display:table id="log" name="secLogList" cellspacing="1" cellpadding="5" class="forumline" pagesize="20" sort="list" requestURI="">
            ...
            <display:column property="resource" sortable="true" title='<c:out value='${sessionScope["drac.auditlogs.list.resource"]}'/>' class="${tdclass}"> </display:column>
