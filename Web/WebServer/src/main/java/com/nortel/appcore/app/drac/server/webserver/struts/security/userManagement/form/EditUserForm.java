 ...
 */
public class EditUserForm extends ValidatorActionForm {
	private static final long serialVersionUID = 8264460314220211072L;

	// Fields pertaining to edit user page.
	...
	// Authentication data
	private ArrayList availAuthenticationTypes = new ArrayList();
	...
	private String password2 = DracConstants.EMPTY_STRING;
	...
	private String[] lockedClientIPsGP = {};
	 ...
	 */
	public ArrayList getAvailAuthenticationTypes() {
	 ...
	 */
	public String[] getLockedClientIPsGP() {
	...
	public String getWebSafeName() throws Exception {
		return DracHelper.encodeToUTF8(getUserID());
	}
	 ...
	 */
	public void setAvailAuthenticationTypes(ArrayList availAuthenticationTypes) {
	 ...
	 */
	public void setLockedClientIPsGP(String[] lockedClientIPsGP) {
