...
package com.nortel.appcore.app.drac.server.ws.common.request;

import com.nortel.appcore.app.drac.server.ws.common.RequestResponseConstants;

public final class QueryAlarmsRequest {
	public static final String QUERY_ALARMS_REQUEST = "srv:"
	    + RequestResponseConstants.RAW_QUERY_ALARMS_REQUEST;

	public static final String START_TIME = "srv:"
	    + RequestResponseConstants.RAW_QUERY_ALARMS_REQUEST + "/srv:"
	...
	public static final String USER_GROUP = "srv:"
	    + RequestResponseConstants.RAW_QUERY_ALARMS_REQUEST + "/srv:"
	    + RequestResponseConstants.RAW_QUERY_CRITERIA + "/srv:"
	    + RequestResponseConstants.RAW_USER_GROUP;

	private QueryAlarmsRequest() {
		super();
	}
