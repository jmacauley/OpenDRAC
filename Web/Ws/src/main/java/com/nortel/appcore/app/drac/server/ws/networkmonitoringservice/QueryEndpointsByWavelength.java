...
public final class QueryEndpointsByWavelength implements EndpointsQuery {
  private final Logger log = LoggerFactory.getLogger(getClass());
	...
	public QueryEndpointsByWavelength(OMElement msg, LoginToken userToken,
	...
	public OMElement prepareResponseOMElement() throws InvalidInputException,
		...
		if ((selectedNode = serviceUtil.getNode(this.inputMsg,
		    ...
		    QueryEndpointsRequest.getWavelengthXPath(namespace))) != null) {
			wavelength = selectedNode.getText().trim();
		}
		else {
			Object[] args = new Object[1];
			args[0] = RequestResponseConstants.RAW_WAVELENGTH;
			throw new InvalidInputException(
			    DracErrorConstants.WS_MISSING_PARAMETER_IN_REQUEST_MESSAGE, args);
		}

		List<EndpointResourceUiType> endpoints = rh.getEndpointsForWavelength(
		    token, wavelength);
