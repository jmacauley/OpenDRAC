...
public final class QueryReservationOccurrencesRequest {
	public static final String QUERY_RESERVATION_OCCURRENCES_REQUEST = "srv:"
	    + RequestResponseConstants.RAW_QUERY_RESERVATION_OCCURRENCES_REQUEST;

	public static final String QUERY_CRITERIA = "srv:"
	    + RequestResponseConstants.RAW_QUERY_RESERVATION_OCCURRENCES_REQUEST
	    + "/srv:" + RequestResponseConstants.RAW_QUERY_CRITERIA;

	public static final String START_TIME = "srv:"
	    + RequestResponseConstants.RAW_QUERY_RESERVATION_OCCURRENCES_REQUEST
	    + "/srv:" + RequestResponseConstants.RAW_QUERY_CRITERIA + "/srv:"
	...
	public static final String USER_GROUP_NAME = "srv:"
	    + RequestResponseConstants.RAW_QUERY_RESERVATION_OCCURRENCES_REQUEST
	    + "/srv:" + RequestResponseConstants.RAW_QUERY_CRITERIA + "/srv:"
	    + RequestResponseConstants.RAW_USER_GROUP;

	private QueryReservationOccurrencesRequest() {
	}
