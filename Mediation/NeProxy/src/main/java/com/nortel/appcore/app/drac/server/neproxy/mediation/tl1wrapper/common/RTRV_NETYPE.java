...
public class RTRV_NETYPE {
	...
	public static Parameter R_BLOCKS[][] = { {
	    new Parameter("MANUF", false, "MANUF"),
	    new Parameter("MODEL", false, "MODEL"),
	    new Parameter("NETYPE", false, "NETYPE"),
	    new Parameter("SWISSUE", false, "SWISSUE") } };
	public static final boolean R_Block_Is_Pos[] = { true };
}
