	...
	public boolean start() {
		...
		if (modifyDBAttribute != null) {
			try {
				...
				// DRAC).
				//
				// The facility is considered as 'configsured' for DRAC when the client
				// side
				...
				if (signalType != null) {
                	...
                	public void run() {
                		 ...
                		 * ETH-1-1-1-1 We can safely append a payload value of '1' to
                		 * this aid (since this is a Layer 2 aid). Also, the aid type
                		 * qualifier at the front end is not important since it is
                		 * stripped off by the add/removeLoopback methods. I will just
                		 * prepend 'na'.
                		 */
                		String modifyAid = "na"
