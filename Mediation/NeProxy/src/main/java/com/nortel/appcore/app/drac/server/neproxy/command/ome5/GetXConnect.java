				...
				while (resultIr.hasNext()) {
					...
					if (cacheConnection.contains(fromAid + ":" + toAid)) {
						...
						String newConnection = "<edge" + " id=\""
						    + aResult.get("CKTID").replaceAll("&", " and ") + "\" type=\""
						    + aResult.get("CCT") + "\" rate=\"" + rate + "\" source=\""
						    + neId +

						    "\" sShelf=\"" + fromAidArray[1] + "\" sSlot=\""
						    + fromAidArray[2] + "\" sSubslot=\"" + 0 + "\" sPort=\""
						    + fromAidArray[3] + "\" sChannel=\"" + fromAidArray[4]
						    + "\" target=\"" + neId + "\" sourceAid=\"" + fromAid +

						    "\" tShelf=\"" + toAidArray[1] + "\" tSlot=\"" + toAidArray[2]
						    + "\" tSubslot=\"" + 0 + "\" tPort=\"" + toAidArray[3]
						    + "\" tChannel=\"" + toAidArray[4] + "\" targetAid=\"" + toAid
						    + "\" swmate=\"" + (swMate == null ? "" : swMate)
						    + "\" committed=\"true\" />";
