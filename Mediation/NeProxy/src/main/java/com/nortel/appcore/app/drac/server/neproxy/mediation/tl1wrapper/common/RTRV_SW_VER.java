 ...
 * @author nguyentd
 */
public class RTRV_SW_VER {
	public static final boolean isMOD2Required = true;
	...
	public static Parameter R_BLOCKS[][] = {
	    { new Parameter("AID", false, "AID") },
	    { new Parameter("NE SW_VERSION", false, "NE SW_VERSION") } };
	public static final boolean R_Block_Is_Pos[] = { true, true };
}
