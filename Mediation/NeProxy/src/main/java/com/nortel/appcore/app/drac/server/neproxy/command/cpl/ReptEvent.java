...
public final class ReptEvent extends AbstractCommandlet {
	// private final String condType = "DOCSTATUS";

	public ReptEvent(Map<String, Object> param) {
		super(param);
	}
	...
	public boolean start() {
		...
		log.debug("CPL ReptEvent: Process/ignoring Event event from "
		    + ne.getNeName() + ": " + values);
		// String aid = (String) values.get("AID");
		// String description = (String) values.get("CONDDESCR");
		// String conditionType = (String) values.get("CONDTYPE");
