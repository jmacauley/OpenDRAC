...
/**
 * @author nguyentd This class is use HDX NE
 */
public class RTRV_NE {
	...
	public static Parameter R_BLOCKS[][] = { {
	    new Parameter("NEROLE", false, "NEROLE"),
	    new Parameter("NEMODE", false, "NEMODE"),
	    new Parameter("NEALIAS", false, "NEALIAS"),
	    new Parameter("NELOC", false, "NELOC"),
	    new Parameter("NEFUNCTION", false, "NEFUNCTION"),
	    new Parameter("SLATMODE", false, "SLATMODE") } };
