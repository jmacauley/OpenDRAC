 ...
 * @author nguyentd
 */
public class AddConnection extends AbstractCommandlet {
	private final String targetNeId;
	private static final String EVENT_CODE = "ENT-CRS";

	public AddConnection(Map<String, Object> param) {
		super(param);
	...
	public boolean start() {
		...
		try {
			...
			log.debug("AddConnection invoking commandlet " + className + " for "
			    + EVENT_CODE);
			...
			log.error("AddConnection: Failed to invoke handler", e);
		}
