 ...
 * @author nguyentd
 */
public final class GetVCS extends AbstractCommandlet {
	public GetVCS(Map<String, Object> param) {
		super(param);
	}
		...
		try {
			...
			if (result != null) {
				for (Map<String, String> aResult : result) {
					...
					HashMap<String, String> vcsAttrList = new HashMap<String, String>();
					vcsAttrList.put(AbstractFacilityXml.VALID_ATTR, "true");

					// Not normalized yet:
					vcsAttrList.putAll(aResult);
			...
			log.error("Failed to retrieve VCS facility", e);
		}
		return false;
	}
